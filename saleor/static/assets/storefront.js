...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../scss/storefront.scss */ 320);
	
	__webpack_require__(/*! jquery.cookie */ 188);
	...
	var _svgInjector = __webpack_require__(/*! svg-injector-2 */ 144);
	
	var _svgInjector2 = _interopRequireDefault(_svgInjector);
	
	var _variantPicker = __webpack_require__(/*! ./stores/variantPicker */ 226);
	
	var _variantPicker2 = _interopRequireDefault(_variantPicker);
	
	var _pass_invisible = __webpack_require__(/*! ../images/pass_invisible.svg */ 356);
	
	var _pass_invisible2 = _interopRequireDefault(_pass_invisible);
	
	var _pass_visible = __webpack_require__(/*! ../images/pass_visible.svg */ 357);
	
	var _pass_visible2 = _interopRequireDefault(_pass_visible);
	
	var _VariantPicker = __webpack_require__(/*! ./components/variantPicker/VariantPicker */ 224);
	
	var _VariantPicker2 = _interopRequireDefault(_VariantPicker);
	
	var _VariantPrice = __webpack_require__(/*! ./components/variantPicker/VariantPrice */ 225);
	
	var _VariantPrice2 = _interopRequireDefault(_VariantPrice);
	
	var _ProductSchema = __webpack_require__(/*! ./components/variantPicker/ProductSchema */ 222);
	...
	$("<img class='passIcon' src=" + _pass_invisible2.default + " />").insertAfter($inputPassword);
	$inputPassword.parent().addClass('relative');
	$('.passIcon').on('click', function (e) {
	  var $input = $(e.target).parent().find('input');
	  if ($input.attr('type') == 'password') {
	    $input.attr('type', 'text');
	    $(e.target).attr('src', _pass_visible2.default);
	  } else {
	    $input.attr('type', 'password');
	    $(e.target).attr('src', _pass_invisible2.default);
	  }
	});
	...
	if (variantPickerContainer) {
	  ...
	  var customAttributeData = JSON.parse(variantPickerContainer.dataset.customAttributeData);
	...
	$cartLine.each(function () {
	  ...
	  var $dataInput = $(this).find('#id_data');
	  var cartFormUrl = $(this).find('.form-cart').attr('action');
	  var $quantityError = $(this).find('.cart__line__quantity-error');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? factory(exports, __webpack_require__(/*! mobx */ 189), __webpack_require__(/*! react */ 10), __webpack_require__(/*! react-dom */ 93)) :
...
/***/ 144:
/*!***************************************************!*\
  !*** ./~/svg-injector-2/dist/svg-injector.min.js ***!
  \***************************************************/
/***/ (function(module, exports, __webpack_require__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mobxReact = __webpack_require__(/*! mobx-react */ 127);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _lodash = __webpack_require__(/*! lodash */ 368);
	...
	var _AttributeSelectionWidget = __webpack_require__(/*! ./AttributeSelectionWidget */ 221);
	
	var _AttributeSelectionWidget2 = _interopRequireDefault(_AttributeSelectionWidget);
	
	var _QuantityInput = __webpack_require__(/*! ./QuantityInput */ 223);
	...
	var VariantPicker = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_Component) {
	  ...
	  function VariantPicker(props) {
	    ...
	    var customAttributes = _this.props.customAttributes;
	
	    var defaultVariant = variants.filter(function (v) {
	    ...
	    if (Object.keys(params).length) {
	      Object.keys(params).map(function (name) {
	        ...
	        var variantAttribute = _this.matchVariantAttributeBySlug(name);
	        var customAttribute = _this.matchCustomAttributeBySlug(name);
	        if (customAttribute) {
	          var value = _this.matchAttributeValueByName(customAttribute, valueName);
	          if (value) {
	            customizations[customAttribute.pk] = value.pk.toString();
	          }
	        } else if (variantAttribute) {
	          var _value = _this.matchAttributeValueByName(variantAttribute, valueName);
	          if (_value) {
	            selection[variantAttribute.pk] = _value.pk.toString();
	          }
	        }
	      });
	    }
	    ...
	    _this.updateParams();
	    _this.updateDynamicRender();
	    return _this;
	  }
	
	  _createClass(VariantPicker, [{
	    key: 'updateDynamicRender',
	    value: function updateDynamicRender() {
	      var _this2 = this;
	      ...
	      if (!(0, _jquery2.default)('#dynamic-render').length) {
	        return;
	      }
	      var hieronymusBaseUrl = "https://hieronymus.enstaved.com/render_staff?";
	      var allAttributes = {};
	      Object.keys(this.state.selection).forEach(function (attrId) {
	        var attribute = _this2.matchAttribute(attrId);
	        var value = _this2.matchAttributeValue(attribute, _this2.state.selection[attrId]);
	        if (attribute && value) {
	          allAttributes[attribute.slug] = value.slug;
	        }
	      });
	      Object.keys(this.state.customizations).forEach(function (attrId) {
	        var attribute = _this2.matchAttribute(attrId);
	        var value = _this2.matchAttributeValue(attribute, _this2.state.customizations[attrId]);
	        if (attribute && value) {
	          allAttributes[attribute.slug] = value.slug;
	        }
	      });
	      var params = this.getDynamicRenderParams(allAttributes);
	      var url = hieronymusBaseUrl + queryString.stringify(params);
	      _jquery2.default.get(url, function (src) {
	        (0, _jquery2.default)("#dynamic-render").attr('src', src);
	      }, 'text');
	    }
	  }, {
	    key: 'getDynamicRenderParams',
	    value: function getDynamicRenderParams(attributes) {
	      ...
	      var cIndex = topUnfiltered.lastIndexOf('-');
	    ...
	    value: function updateParams() {
	      ...
	      var params = {};
	      Object.keys(this.state.selection).forEach(function (attrId) {
	        var attribute = _this3.matchAttribute(attrId);
	        var value = _this3.matchAttributeValue(attribute, _this3.state.selection[attrId]);
	        if (attribute && value) {
	      ...
	      Object.keys(this.state.customizations).forEach(function (attrId) {
	        var attribute = _this3.matchAttribute(attrId);
	        var value = _this3.matchAttributeValue(attribute, _this3.state.customizations[attrId]);
	        if (attribute && value) {
	          params[attribute.slug] = value.slug;
	        }
	      });
	    ...
	    value: function matchVariantFromSelection() {
	      ...
	      variants.forEach(function (variant) {
	        if (_lodash2.default.isEqual(_this4.state.selection, variant.attributes)) {
	    ...
	    value: function render() {
	      ...
	      var _props2 = this.props,
	          ...
	          customAttributes = _props2.customAttributes;
	      var _state = this.state,
	          errors = _state.errors,
	          selection = _state.selection,
	          customizations = _state.customizations,
	      ...
	      return _react2.default.createElement(
	        ...
	        variantAttributes.map(function (attribute, i) {
	          return _react2.default.createElement(_AttributeSelectionWidget2.default, {
	            attribute: attribute,
	            handleChange: _this5.handleAttributeChange,
	            key: i,
	        ...
	        customAttributes.map(function (attribute) {
	          return _react2.default.createElement(_AttributeSelectionWidget2.default, {
	            attribute: attribute,
	            handleChange: _this5.handleCustomAttributeChange,
	  ...
	  customAttributes: _react.PropTypes.array.isRequired,
	  ...
	  this.handleAddToCart = function () {
	    ...
	    var _state2 = _this6.state,
	        ...
	        customizations = _state2.customizations;
	
	    if (quantity > 0 && !store.isEmpty) {
	      _jquery2.default.ajax({
	        url: _this6.props.url,
	        method: 'post',
	        data: {
	          quantity: quantity,
	  ...
	  this.handleAttributeChange = function (attrId, valueId) {
	    _this6.setState({
	      selection: Object.assign({}, _this6.state.selection, _defineProperty({}, attrId, valueId))
	    }, function () {
	      _this6.matchVariantFromSelection();
	      _this6.updateParams();
	      _this6.updateDynamicRender();
	    });
	  };
	
	  this.handleCustomAttributeChange = function (attrId, valueId) {
	    _this6.setState({
	      customizations: Object.assign({}, _this6.state.customizations, _defineProperty({}, attrId, valueId))
	    }, function () {
	      _this6.updateParams();
	      _this6.updateDynamicRender();
	    });
	  ...
	  this.handleQuantityChange = function (event) {
	    _this6.setState({ quantity: parseInt(event.target.value) });
	  };
	
	  this.matchAttribute = function (id) {
	    var _props4 = _this6.props,
	        variantAttributes = _props4.variantAttributes,
	        customAttributes = _props4.customAttributes;
	
	    var allAttributes = variantAttributes.concat(customAttributes);
	    var match = allAttributes.filter(function (attribute) {
	      return attribute.pk.toString() === id;
	    });
	    return match.length > 0 ? match[0] : null;
	  };
	
	  this.matchVariantAttributeBySlug = function (slug) {
	    var variantAttributes = _this6.props.variantAttributes;
	  ...
	  this.matchCustomAttributeBySlug = function (slug) {
	    var customAttributes = _this6.props.customAttributes;
	
	    var match = customAttributes.filter(function (attribute) {
	      return attribute.slug === slug;
	    });
	    return match.length > 0 ? match[0] : null;
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mobx = __webpack_require__(/*! mobx */ 189);
...
/***/ 320:
/*!********************************************!*\
  !*** ./saleor/static/scss/storefront.scss ***!
  \********************************************/
/***/ (function(module, exports) {
...
/***/ 356:
/*!*************************************************!*\
  !*** ./saleor/static/images/pass_invisible.svg ***!
  \*************************************************/
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "pass_invisible.svg";

/***/ }),

/***/ 357:
/*!***********************************************!*\
  !*** ./saleor/static/images/pass_visible.svg ***!
  \***********************************************/
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "pass_visible.svg";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(/*! ./../webpack/buildin/module.js */ 145)(module), __webpack_require__(/*! underscore */ 98)))
