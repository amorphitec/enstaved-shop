...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _variantPicker = __webpack_require__(/*! ./stores/variantPicker */ 267);
	...
	var _VariantPicker = __webpack_require__(/*! ./components/variantPicker/VariantPicker */ 265);
	
	var _VariantPicker2 = _interopRequireDefault(_VariantPicker);
	
	var _VariantPrice = __webpack_require__(/*! ./components/variantPicker/VariantPrice */ 266);
	
	var _VariantPrice2 = _interopRequireDefault(_VariantPrice);
	
	var _ProductSchema = __webpack_require__(/*! ./components/variantPicker/ProductSchema */ 263);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _classnames = __webpack_require__(/*! classnames */ 103);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AttributeSelectionWidget = __webpack_require__(/*! ./AttributeSelectionWidget */ 262);
	
	var _AttributeSelectionWidget2 = _interopRequireDefault(_AttributeSelectionWidget);
	
	var _QuantityInput = __webpack_require__(/*! ./QuantityInput */ 264);
	...
	var VariantPicker = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_Component) {
	  ...
	  _createClass(VariantPicker, [{
	    ...
	    value: function matchVariantFromSelection() {
	      ...
	      variants.forEach(function (variant) {
	        if (_lodash2.default.isEqual(_this3.state.selection, variant.attributes)) {
	      ...
	      return _react2.default.createElement(
	        ...
	        variantAttributes.map(function (attribute, i) {
	          return _react2.default.createElement(_AttributeSelectionWidget2.default, {
	            attribute: attribute,
	            handleChange: _this4.handleAttributeChange,
	            key: i,
	        ...
	        customAttributes.map(function (attribute) {
	          return _react2.default.createElement(_AttributeSelectionWidget2.default, {
	            attribute: attribute,
	            handleChange: _this4.handleCustomAttributeChange,
	  ...
	  this.handleAttributeChange = function (attrId, valueId) {
	    _this5.setState({
	      selection: Object.assign({}, _this5.state.selection, _defineProperty({}, attrId, valueId))
	    }, function () {
	      _this5.matchVariantFromSelection();
	      _this5.updateParams();
	    });
	  };
	  ...
	  this.handleCustomAttributeChange = function (attrId, valueId) {
	    _this5.setState({
	      customizations: Object.assign({}, _this5.state.customizations, _defineProperty({}, attrId, valueId))
	    }, function () {
	      _this5.updateParams();
	    });
	  };
	  ...
	  this.handleQuantityChange = function (event) {
	    _this5.setState({ quantity: parseInt(event.target.value) });
	  };
	  ...
	  this.matchVariantAttributeBySlug = function (slug) {
	    var variantAttributes = _this5.props.variantAttributes;
	  ...
	  this.matchCustomAttributeBySlug = function (slug) {
	    var customAttributes = _this5.props.customAttributes;
